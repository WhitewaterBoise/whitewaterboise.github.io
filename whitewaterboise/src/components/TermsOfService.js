  ...
  return (
    <div className="max-w-3xl mx-auto p-8 space-y-6">
      ...
      <section>
        ...
        <p className="text-gray-700">
          You are responsible for using our services in a lawful manner and for
          any activity that occurs under your account. You agree not to misuse
          or abuse our services.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700">
          ...
          not limited to, illegal activities, infringing on intellectual
          property rights, spamming, or distributing harmful software.
        </p>
      </section>
