      ...
      <PageNavBar></PageNavBar>
        ...
        <section className="about-hero">
          <div className="hero-content">
            ...
            <p>Meet our dedicated team committed to your mental health and well-being.</p>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="team-member">
              ...
              <div className="team-member-info">
                ...
                <p>
                Gayle Matsumuro is a Psychiatric Mental Health Nurse Practitioner (PMHNP) with extensive experience in adolescent and adult mental health care. She specializes in treating mood disorders, anxiety, and depression with a focus on providing compassionate, individualized care. Gayle is known for her collaborative approach, working closely with teens and their families to create personalized treatment plans. She combines medication management with therapeutic support, helping young patients navigate mental health challenges and build resilience. Gayle is passionate about mental health advocacy and continually stays informed on the latest advancements to offer her patients the best in evidence-based care.
                </p>
                <h4>Specializations:</h4>
                <ul>
